...
#define VBATT_SNS_P_Pin GPIO_PIN_0
#define VBATT_SNS_P_GPIO_Port GPIOA
#define VBATT_SNS_N_Pin GPIO_PIN_1
#define VBATT_SNS_N_GPIO_Port GPIOA
#define USART_TX_Pin GPIO_PIN_2
#define USART_TX_GPIO_Port GPIOA
#define USART_RX_Pin GPIO_PIN_3
#define USART_RX_GPIO_Port GPIOA
#define VBATT_LOAD_Pin GPIO_PIN_4
